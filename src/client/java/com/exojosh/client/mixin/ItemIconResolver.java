 ...
 * through ItemRenderer into an offscreen framebuffer, meaningfully more
 * code. Fine starting point for the common cases; revisit if specific
 * items still show blank or wrong.
 *
